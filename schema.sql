...
CREATE TABLE WALLET (
	...
	CONSTRAINT wallet_client FOREIGN KEY (client_id) REFERENCES CLIENT (id)
);
...
CREATE TABLE EXPENSE (
	...
	created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
	updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
	CONSTRAINT expense_type FOREIGN KEY (type) REFERENCES EXPENSE_TYPE (id),
	CONSTRAINT expense_state FOREIGN KEY (state) REFERENCES EXPENSE_STATE (id)
);
